...
export const caseStudy = {
  ...
  title: 'Exploring Blockchain´s Potential in Healthcare Industry',
  description:
    'Viken Blockchain Solutions is at the forefront of health data management, leveraging blockchain technology to ensure secure and decentralized data storage in the healthcare sector.',
  summary: [
